...
export const metadata: Metadata = {
  title: "Étanchéité Bitume à Limoges | Les Cœurs de Madagascar",
  description:
...
export default function EtancheiteBitume() {
  return (
    <ServicePage
      ...
      subtitle="Située à Limoges, dans les environs de Guéret, la société Les Cœurs de Madagascar est spécialisée dans la réalisation d'étanchéité bitume. Elle intervient dans tout le secteur pour procéder à la pose de membranes bitumineuses."
      ...
      sections={[
        {
          ...
          content: [
            "Établie à Limoges, à proximité de Guéret, l'entreprise Les Cœurs de Madagascar prend en charge des chantiers d'étanchéité bitume de manière très professionnelle. Elle affiche en effet une vingtaine d'années d'expérience de ce type de travaux dans les départements 87, 19, 23 et 24.",

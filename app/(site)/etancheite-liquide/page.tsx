...
export const metadata: Metadata = {
  title: "Étanchéité Liquide à Limoges | Étanchéité du Limousin",
  description:
...
export default function EtancheiteLiquide() {
  return (
    <ServicePage
      ...
      subtitle="Installée à Limoges, près de Guéret, la société Étanchéité du Limousin met en œuvre des systèmes d'étanchéité liquide très efficaces."
      ...
      sections={[
        {
          ...
          content: [
            "Basée à Limoges, non loin de Guéret, l'entreprise Étanchéité du Limousin est spécialisée dans la réalisation de systèmes d'étanchéité liquide. Forte d'une vingtaine d'années d'expérience, elle est en mesure de vous proposer des solutions à base de résines dans les départements 87, 19, 23 et 24.",
